        ...
        return (
            <div className="App" style={{marginTop: '80px'}}>
                <Content style={{padding: '0 50px'}}>
                    <Breadcrumb>
                        <Breadcrumb.Item>
                            <a href="http://129.211.98.114:3006/web/v0_1_7/index.html">Home</a>
                        </Breadcrumb.Item>
                        <Breadcrumb.Item>
                                    ...
                                    <Row>
                                        <Col span={12}>
                                            <List.Item.Meta
                                                ...
                                                title={
                                                    <a href={`http://129.211.98.114:3006/web/v0_1_7/account-detail.html?pk=${currentAccount.PK}`}><small>{accountName ? accountName.substring(0, 30) + "..." : ""}{this.state.ct_details.isKing ?
